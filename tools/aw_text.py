#!/usr/bin/env python3
"""aw_text.py - AW static font + English string table (from rawgl staticres.cpp).
Auto-generated by _gen_text.py; do not edit by hand. FONT = 96 glyphs x 8 bytes
(ASCII 0x20-0x7F, MSB-first). STRINGS = {id: text}. draw_string() renders glyphs
into a page exactly like AW drawString/drawChar, so aw_sim (oracle) and aw_play
(replay) agree byte-for-byte."""
